...
|---|---|---|---:|---:|---:|---:|---|---|
| Capability/schema probe | once before PRE_DEPLOY | open exact source in Studio and inspect compiled public schema | 0 | 0 | 0 | 1 schema inventory | none | 12 methods visible or stop |
